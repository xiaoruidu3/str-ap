...
public:
    METHOD_LIST_BEGIN
        ...
        ADD_METHOD_TO(STRController::getRotterdamTestInfo, "/api/v0/str/rotterdam/{unitid}", drogon::Get,
                      "JwtAuth0Filter");
        ADD_METHOD_TO(STRController::getAmsterdamTestInfo, "/api/v0/str/amsterdam/{areaid}", drogon::Get,
                      "JwtAuth0Filter");
    METHOD_LIST_END
